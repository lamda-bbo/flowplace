...
from mask_guided_data_generation import  GridPlacement, MaskGuidedDataGeneration
...
class V1:
    ...
    def sample(self):
        ...
        num_terminals = get_distribution(**self.num_terminals_dist).sample((num_instances,)).int()
